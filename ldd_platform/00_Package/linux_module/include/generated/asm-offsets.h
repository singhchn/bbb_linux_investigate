...
#define TSK_STACK_CANARY 1272 /* offsetof(struct task_struct, stack_canary) */
...
#define TI_IWMMXT_STATE 96 /* offsetof(struct thread_info, fpstate.iwmmxt) */
...
#define VMA_VM_MM 8 /* offsetof(struct vm_area_struct, vm_mm) */
#define VMA_VM_FLAGS 16 /* offsetof(struct vm_area_struct, vm_flags) */
