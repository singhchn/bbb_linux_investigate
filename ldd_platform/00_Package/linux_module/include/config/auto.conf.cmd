...
ifneq "$(KERNELVERSION)" "6.1.43"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-training-linux-uclibcgnueabihf-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-training-linux-uclibcgnueabihf-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-training-linux-uclibcgnueabihf-gcc (crosstool-NG 1.25.0.199_36ad0b1) 12.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-training-linux-uclibcgnueabihf-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-training-linux-uclibcgnueabihf-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "arm-training-linux-uclibcgnueabihf-ar"
include/config/auto.conf: FORCE
endif
