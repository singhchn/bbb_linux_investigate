...
.ascii "->SIZE_acpi_device_id #28 sizeof(struct acpi_device_id)"	@
@ 0 "" 2
...
.ascii "->OFF_acpi_device_id_cls #20 offsetof(struct acpi_device_id, cls)"	@
@ 0 "" 2
@ scripts/mod/devicetable-offsets.c:69: 	DEVID_FIELD(acpi_device_id, cls_msk);
@ 69 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_acpi_device_id_cls_msk #24 offsetof(struct acpi_device_id, cls_msk)"	@
@ 0 "" 2
...
.ascii "->SIZE_ishtp_device_id #20 sizeof(struct ishtp_device_id)"	@
@ 0 "" 2
