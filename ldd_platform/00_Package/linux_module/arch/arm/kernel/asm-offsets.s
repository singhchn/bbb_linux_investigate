...
.ascii "->TSK_STACK_CANARY #1272 offsetof(struct task_struct, stack_canary)"	@
@ 0 "" 2
...
@ 0 "" 2
@ arch/arm/kernel/asm-offsets.c:63:   DEFINE(TI_IWMMXT_STATE,	offsetof(struct thread_info, fpstate.iwmmxt));
@ 63 "arch/arm/kernel/asm-offsets.c" 1
	
.ascii "->TI_IWMMXT_STATE #96 offsetof(struct thread_info, fpstate.iwmmxt)"	@
@ 0 "" 2
